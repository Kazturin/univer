    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <x-breadcrumbs class="mt-2"
                           :links="[
                           ['url'=>route('tutor.index'),'label'=>'ППС и сотрудники'],
                           ['url'=>route('tutor.show',$tutor->TutorID),'label'=>$tutor->lastname.' '.$tutor->firstname.' '.$tutor->patronymic],
                    ...
                    <div class="card border-top border-0 border-4 border-info">
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <form action="{{ route('tutor.update', $tutor->TutorID) }}" method="POST" autocomplete="off">
                                    @csrf
                                    @method('put')
                                <div class="tab-content pt-5" id="tab-content">
                                    <div class="tab-pane active" id="tabpanel-personal" role="tabpanel" aria-labelledby="tab-personal">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputFirstname" name="firstname" value="{{ $tutor->firstname }}" placeholder="Фамилия">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputLastname" class="col-sm-3 col-form-label">Имя</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputLastname" name="lastname" value="{{ $tutor->lastname }}" placeholder="Имя">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputPatronymic" class="col-sm-3 col-form-label">Отчество</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputPatronymic" name="patronymic" value="{{ $tutor->patronymic }}" placeholder="Отчество">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputLastnamePrevious" class="col-sm-3 col-form-label">Прежняя фамилия</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputLastnamePrevious" name="lastnamePrevious" value="{{ $tutor->lastnamePrevious }}" placeholder="Прежняя фамилия">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputIIN" class="col-sm-3 col-form-label">ИИН</label>
                                                <div class="col-sm-9">
                                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="form-control" id="inputIIN" name="iinplt" value="{{ $tutor->inputIIN }}" placeholder="ИИН">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="birthDate" class="col-sm-3 col-form-label form-label">Дата рождения</label>
                                                <div class="col-sm-9">
                                                    <input id="birthDate" type="date" name="BirthDate" value="{{ $tutor->BirthDate }}" class="form-control datepicker" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="inputNation" class="form-select" name="NationID" data-placeholder="Национальность">
                                                        ...
                                                        @foreach($nationalities as $n)
                                                            <option value={{ $n->Id }} {{ $tutor->NationID == $n->Id ? 'selected' : '' }}> {{ $n->NameKZ }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="inputType" class="form-select" name="citizenshipID" data-placeholder="Тип">
                                                        ...
                                                        @foreach($countries as $c)
                                                            <option value={{ $c->id }} {{ $tutor->citizenshipID == $c->id ? 'selected' : '' }}> {{ $c->namekz }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="inputSex" class="form-select" name="SexID">
                                                        <option value="">Выбирать</option>
                                                        <option value=1 {{ $tutor->SexID == 1 ? 'selected' : '' }}> Женский </option>
                                                        <option value=2 {{ $tutor->SexID == 2 ? 'selected' : '' }}> Мужской </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="inputIsmarried" class="form-select" name="ismarried" data-placeholder="Семейное положение">
                                                        <option value="">Выбирать</option>
                                                        <option value=1 {{ $tutor->ismarried == 1 ? 'selected' : '' }}> Женат/Замужем </option>
                                                        <option value=2 {{ $tutor->ismarried == 2 ? 'selected' : '' }}> Холост/Не замужем </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputAddress" name="adress" value="{{ $tutor->adress }}" placeholder="Адрес прописки">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputLivingAddress" class="col-sm-3 col-form-label">Адрес проживания</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputLivingAddress" name="living_adress" value="{{ $tutor->living_adress }}" placeholder="Адрес проживания">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="percoid" class="col-sm-3 col-form-label">Код карточки</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="percoid" name="percoid" value="{{ $tutor->percoid }}" placeholder="Код карточки">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="has_access" class="col-sm-3 form-check-label">Доступ к системе</label>
                                                <div class="col-sm-9">
                                                    <input type="checkbox" class="form-check-input" id="has_access"  {{  $tutor->has_access ? 'checked':'' }} name="has_access">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="deleted" class="col-sm-3 form-check-label">Уволен</label>
                                                <div class="col-sm-9">
                                                    <input type="checkbox" class="form-check-input" id="deleted" {{  $tutor->deleted ? 'checked':'' }} name="deleted">
                                                </div>
                                            </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="inputRoles" class="select-roles" name="roles[]" data-placeholder="Choose anything" multiple="multiple">
                                                    ...
                                                    @foreach($roles as $role)
                                                        <option value="{{$role->RoleID}}" {{ in_array($role->RoleID,$rolesId) ? 'selected' : ''  }}>{{$role->RoleNameKZ}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <button type="submit" class="btn btn-info px-5 text-white">Изменить</button>
                                                </div>
                                            </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="inputDocType" class="form-select" name="ictype">
                                                    <option value="">Выбирать</option>
                                                    <option value=1 {{ $tutor->ictype == 1 ? 'selected' : '' }}>удостоверение личности</option>
                                                    <option value=2 {{ $tutor->ictype == 2 ? 'selected' : '' }}>паспорт</option>
                                                    <option value=3 {{ $tutor->ictype == 3 ? 'selected' : '' }}>свидетельство о рождении</option>
                                                    <option value=4 {{ $tutor->ictype == 4 ? 'selected' : '' }}>вид на жительство</option>
                                                    <option value=5 {{ $tutor->ictype == 5 ? 'selected' : '' }}>другой документ</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" inputmode="numeric" class="form-control" id="icnumber" name="icnumber" value="{{ $tutor->icnumber }}" placeholder="Номер документа, удостоверяющего личность">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="icseries" class="col-sm-3 col-form-label">Серия документа, удостоверяющего личность</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="icseries" name="icseries" value="{{ $tutor->icseries }}" placeholder="Серия документа, удостоверяющего личность">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="icdate" class="col-sm-3 col-form-label form-label">Дата выдачи документа, удостоверяющего личность</label>
                                            <div class="col-sm-9">
                                                <input id="icdate" type="date" name="icdate" value="{{ $tutor->icdate }}" class="form-control datepicker" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="icdepartment" class="col-sm-3 col-form-label">Орган, выдавший документ, удостоверяющий личность</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="icdepartment" name="icdepartment" value="{{ $tutor->icdepartment }}" placeholder="Орган, выдавший документ, удостоверяющий личность">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tabpanel-contact" role="tabpanel" aria-labelledby="tab-contact">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" inputmode="numeric" class="form-control" id="phone" name="phone" value="{{ $tutor->phone }}" placeholder="Домашний телефон">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="mobilePhone" class="col-sm-3 col-form-label">Мобильный телефон</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="mobilePhone" name="mobilePhone" value="{{ $tutor->mobilePhone }}" placeholder="Мобильный телефон">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="mail" class="col-sm-3 col-form-label">Почта</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="mail" name="mail" value="{{ $tutor->mail }}" placeholder="Почта">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tabpanel-edu" role="tabpanel" aria-labelledby="tab-edu">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="edubase" name="edubase" rows="3" placeholder="Базовое образование">{{ $tutor->edubase }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="rang" class="col-sm-3 col-form-label">Достижения</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="rang" name="rang" rows="3" placeholder="Достижения">{{ $tutor->rang }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="ScientificFieldID" class="form-select" name="ScientificFieldID">
                                                    ...
                                                    @foreach($scienceFields as $sf)
                                                        <option value={{ $sf->Id }} {{ $tutor->ScientificFieldID == $sf->Id ? 'selected' : '' }}> {{ $sf->NameRU }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="ScientificDegreeID" class="form-select" name="ScientificDegreeID">
                                                    ...
                                                    @foreach($scientificDegree as $sd)
                                                        <option value={{ $sd->ID }} {{ $tutor->ScientificDegreeID == $sd->ID ? 'selected' : '' }}> {{ $sd->NAMERU }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select id="AcademicStatusID" class="form-select" name="AcademicStatusID">
                                                    ...
                                                    @foreach($academicStatus as $as)
                                                        <option value={{ $as->id }} {{ $tutor->AcademicStatusID == $as->id ? 'selected' : '' }}> {{ $as->nameru }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div x-data="{ teacher: '1' }" class="tab-pane" id="tabpanel-kard" role="tabpanel" aria-labelledby="tab-kadr">

                                        <div class="row mb-3">
                                            <label for="categorySelect" class="col-sm-3 col-form-label">Категория</label>
                                            <div class="col-sm-9">
                                                <select id="categorySelect" x-model="teacher" class="form-select">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="StartDate" type="date" name="StartDate" value="{{ $tutor->StartDate }}" class="form-control datepicker" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="work_start_date" class="col-sm-3 col-form-label form-label">Дата начала рабочего стажа</label>
                                            <div class="col-sm-9">
                                                <input id="work_start_date" type="date" name="work_start_date" value="{{ $tutor->work_start_date }}" class="form-control datepicker" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="teaching_experience_start_date" class="col-sm-3 col-form-label form-label">Дата начала НПС</label>
                                            <div class="col-sm-9">
                                                <input id="teaching_experience_start_date" type="date" name="teaching_experience_start_date" value="{{ $tutor->teaching_experience_start_date }}" class="form-control datepicker" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="maternity_leave" class="col-sm-3 form-check-label">В декретном отпуске</label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" class="form-check-input" id="maternity_leave" {{  $tutor->maternity_leave ? 'checked':'' }} name="maternity_leave">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="on_foreign_trip" class="col-sm-3 form-check-label">В зарубежной командировке</label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" class="form-check-input" id="on_foreign_trip" {{  $tutor->on_foreign_trip ? 'checked':'' }} name="on_foreign_trip">
                                            </div>
                                        </div>
                                        <div x-show="teacher==0" class="row mb-3">
                                            <label for="inputDocType" class="col-sm-3 col-form-label">Структурное подразделение</label>
                                            <div class="col-sm-9">
                                                <select id="inputDocType" class="form-select" name="departmentid">
                                                    <option value="">Выбирать</option>
                                                    @foreach($subdivisions as $s)
                                                        <option value={{ $s->id }} {{ $tutor->departmentid == $s->id ? 'selected' : '' }}> {{ $s->nameru }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div x-show="teacher==1" class="row mb-3"
                                        >
                                            <label for="ftutor" class="col-sm-3 form-check-label">Иностранный преподаватель</label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" class="form-check-input" id="ftutor" {{  $tutor->ftutor ? 'checked':'' }} name="ftutor">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="timetable_description" class="col-sm-3 col-form-label">Звание в краткой форме (для отображения в расписании)</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="timetable_description" name="timetable_description" value="{{ $tutor->timetable_description }}" placeholder="Звание в краткой форме (для отображения в расписании)">
                                            </div>
                                        </div>
                                        <div x-show="teacher==1">
                                            @livewire('create-tutor-cafedra',['tutorId' => $tutor->TutorID])
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tabpanel-other" role="tabpanel" aria-labelledby="tab-other">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="additionalInformation" name="additionalInformation" value="{{ $tutor->additionalInformation }}" placeholder="Дополнительная информация">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="dljnEDO" class="col-sm-3 col-form-label">Занимаемая должность</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="dljnEDO" name="dljnEDO" value="{{ $tutor->dljnEDO }}" placeholder="Занимаемая должность">
                                            </div>
                                        </div>
